...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        "border-input has-aria-invalid:border-destructive has-aria-invalid:ring-destructive/20 dark:bg-input/30 dark:has-aria-invalid:border-destructive/50 dark:has-aria-invalid:ring-destructive/40 relative flex min-h-8 flex-wrap items-center gap-1 rounded-lg border bg-transparent bg-clip-padding px-2.5 py-1 text-sm transition-colors has-aria-invalid:ring-3 has-data-[slot=combobox-chip]:px-1",
        className,
      )}
      {...props}
    >
...
function ComboboxChipsInput({
  ...
  return (
    <div className="flex min-w-16 flex-1 items-center gap-1">
      ...
      />
      {showTrigger && (
        <ComboboxTrigger className="text-muted-foreground/50 hover:text-muted-foreground mr-1.5 ml-auto size-4 shrink-0 transition-colors" />
      )}
    </div>
  );
}
