...
function ComboboxChipsInput({
  ...
  return (
    <div className="flex min-w-16 flex-1 items-center gap-1">
      ...
      />
      {showTrigger && (
        <ComboboxTrigger className="mr-1.5 ml-auto size-4 shrink-0 text-muted-foreground/50 transition-colors hover:text-muted-foreground" />
      )}
    </div>
  );
}
